...
class _RideChatScreenState extends State<RideChatScreen> {
  ...
  Future<void> _loadMessages() async {
    ...
    try {
      ...
      // Utiliser ChatService avec le type 'ride'
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      _socketService.sendRideMessage(widget.rideId, trimmedMessage);
...
class _MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final authService = Provider.of<AuthService>(context, listen: false);
    final isOwnMessage = message.auteur == (currentUserId ?? authService.user?.id);
        ...
        children: [
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                if (!isOwnMessage && message.auteurPseudo != null)
                  Padding(
